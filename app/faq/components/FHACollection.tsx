...
export default function FHACollection() {
        ...
        <>
            ...
            >
                <div className="md:text-3xl text-xl font-semibold pt-2 pb-6 border-b border-b-white/50">
                    ...
                    <p className="sm:text-base text-sm opacity-80">This section addresses questions specifically related to FHA loans and first-time homebuyers.</p>
                </div>
                <div>
                    {FaQs.fhaAndFirstTimeHomebuyers.map((faq, index) => (
