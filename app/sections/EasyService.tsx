...
export default function EasyService() {
    return (
        <div className="py-8 bg-white">
            <section className="max-w-[1400px] mx-auto grid md:grid-cols-2 grid-cols-1 gap-8 py-8 sm:px-24 px-8">
                <div className="flex flex-col gap-6">
                    <h1 className="text-5xl uppercase font-semibold">Easy steps to use our service</h1>
